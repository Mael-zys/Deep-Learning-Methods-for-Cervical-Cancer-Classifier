...
def fpn_resnet34(pretrained=False, **kwargs):
...
def fpn_resnet50(pretrained=False, **kwargs):
...
def fpn_resnet101(pretrained=False, **kwargs):
...
def fpn_resnet152(pretrained=False, **kwargs):
...
if __name__ == "__main__":
    model = fpn_resnet50(False, num_classes = 2)
